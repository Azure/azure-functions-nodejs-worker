...
async function generateProtos() {
    ...
    if ((process.version.startsWith("v12") || process.version.startsWith("v14") || process.version.startsWith("v16")) && process.platform === 'win32') {
        console.warn("Warning! Could not compile to TypeScript for Node.js 12 or 14 or v16 and Windows OS. Do not change public interfaces.");
    } else {
        genTs(allFiles)
