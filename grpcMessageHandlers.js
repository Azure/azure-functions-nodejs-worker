...
module.exports = {
  'handleFunctionLoadRequest': function (functionLoadRequest, loadedFunctionsList) {
  ...
  'handleInvokeRequest': function (invocationRequest, call, requestId, loadedFunctionsList) {
  ...
  'buildFunctionLoadResponse': function (requestId, functionId) {
    let statusResult = new messages.StatusResult();
    statusResult.setStatus(messages.StatusResult.Status.SUCCESS);
  ...
  'buildStartStream': function (requestId) {
