 ...
 * @param {(HttpRequest | string | Buffer | null | undefined)[]} args Optional array of input and trigger binding 
 ...
 */
export type AzureFunction = ((context: Context, ...args: (HttpRequest | string | Buffer | null | undefined)[]) => Promise<any> | void);
